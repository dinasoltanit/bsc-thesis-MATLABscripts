...
%-----------------------------General-------------------------------------**
ref=0.05e-3; Vn=0; Vp=4000; %Vm=4000*sqrt(2); Vp=Vm*sin(2*pi*fm*taw);
...
for j=1:cd1
    %rs=[j,xj,yj]
    r(j,1)=j;
    r(j,2)=13*(10^(-3))+(ref/2)+(j-1)*ref; r(j,3)=1.1*(10^(-3)); r(j,4)=ref; r(j,5)=0;
end
% cd2
for j=1+cd1:cd2+cd1
    %r=[j,xj,yj]
    r(j,1)=j; r(j,2)=13.75*(10^(-3))+(ref/2)+(j-1)*ref; r(j,3)=0.1*(10^(-3)); r(j,4)=ref; r(j,5)=pi;
end
%cd3
for j=1+cd1+cd2:cd3+cd1+cd2
    %r=[j,xj,yj]
    r(j,1)=j; r(j,2)=16.75*(10^(-3)); r(j,3)=0+(ref/2)+(j-1)*ref; r(j,4)=ref; r(j,5)=pi/2;
end
%cd4
for j=1+cd1+cd2+cd3:cd4+cd1+cd2+cd3
    %r=[j,xj,yj]
    r(j,1)=j; r(j,2)=13.75*(10^(-3)); r(j,3)=0+(ref/2)+(j-1)*ref; r(j,4)=ref; r(j,5)=(3*pi)/2;
end
%cd5
for j=1+cd1+cd2+cd3+cd4:cd5+cd1+cd2+cd3+cd4
    %r=[j,xj,yj]
    r(j,1)=j; r(j,2)=13.5*(10^(-3)); r(j,3)=1.1*(10^(-3))+(ref/2)+(j-1)*ref; r(j,4)=ref; r(j,5)=pi/2;
end
%ca1
for j=1+cd1+cd2+cd3+cd4+cd5:ca1+cd1+cd2+cd3+cd4+cd5
    %r=[j,xj,yj]
    r(j,1)=j; r(j,2)=13*(10^(-3))+(ref/2)+(j-1)*ref; r(j,3)=1.2*(10^(-3)); r(j,4)=ref; r(j,5)=pi;
end
%ca2
for j=1+cd1+cd2+cd3+cd4+cd5+ca1:ca2+cd1+cd2+cd3+cd4+cd5+ca1
    %r=[j,xj,yj]
    r(j,1)=j; r(j,2)=13*(10^(-3)); r(j,3)=1.1*(10^(-3))+(ref/2)+(j-1)*ref; r(j,4)=ref; r(j,5)=(3*pi)/2;
end
...
%da1
for j=1+Ns:da1+Ns
   r(j,1)=j; r(j,2)=0+(ref/2)+(j-1)*ref; r(j,3)=1.1*(10^(-3)); r(j,4)=ref; r(j,5)=pi;
end
%Nd= da1+da2+da3+da4+da5+dd1+dd2+dd3+dd4;
%da2
for j=1+Ns+da1:da2+Ns+da1
   r(j,1)=j; r(j,2)=16.75*(10^(-3))+(ref/2)+(j-1)*ref; r(j,3)=1.1*(10^(-3)); r(j,4)=ref; r(j,5)=pi;
end
%Nd= da1+da2+da3+da4+da5+dd1+dd2+dd3+dd4;
%da3
for j=1+Ns+da1+da2:da3+Ns+da1+da2
   r(j,1)=j; r(j,2)=13.5*(10^(-3)); r(j,3)=1.2*(10^(-3))+(ref/2)+(j-1)*ref; r(j,4)=ref; r(j,5)=(3*pi)/2;
end
%Nd= da1+da2+da3+da4+da5+dd1+dd2+dd3+dd4;
%da4
for j=1+Ns+da1+da2+da3:da4+Ns+da1+da2+da3
    r(j,1)=j; r(j,2)=13.5*(10^(-3))+(b/(2*da4))+(j-1)*(b/da4); r(j,3)=1.2*(10^(-3))+(a/(2*da4))+(j-1)*(a/da4); r(j,4)=(sqrt(a^2+b^2))/(da4); r(j,5)=pi-atan(a/b);
end
%Nd= da1+da2+da3+da4+da5+dd1+dd2+dd3+dd4;
%da5
for j=1+Ns+da1+da2+da3+da4:da5+Ns+da1+da2+da3+da4
   r(j,1)=j; r(j,2)=16.5*(10^(-3))+(ref/2)+(j-1)*ref; r(j,3)=1.1*(10^(-3)); r(j,4)=ref; r(j,5)=pi;
end
%Nd= da1+da2+da3+da4+da5+dd1+dd2+dd3+dd4;
%dd1
for j=1+Ns+da1+da2+da3+da4+da5:dd1+Ns+da1+da2+da3+da4+da5
   r(j,1)=j; r(j,2)=13.5*(10^(-3))+(ref/2)+(j-1)*ref; r(j,3)=1.1*(10^(-3)); r(j,4)=ref; r(j,5)=pi;
end
%Nd= da1+da2+da3+da4+da5+dd1+dd2+dd3+dd4;
%dd2
for j=1+Ns+da1+da2+da3+da4+da5+dd1:dd2+Ns+da1+da2+da3+da4+da5+dd1
   r(j,1)=j; r(j,2)=16.75*(10^(-3)); r(j,3)=0.1*(10^(-3))+(ref/2)+(j-1)*ref; r(j,4)=ref; r(j,5)=pi/2;
end
%Nd= da1+da2+da3+da4+da5+dd1+dd2+dd3+dd4;
%dd3
for j=1+Ns+da1+da2+da3+da4+da5+dd1+dd2:dd3+Ns+da1+da2+da3+da4+da5+dd1+dd2
   r(j,1)=j; r(j,2)=13*(10^(-3)); r(j,3)=0.1*(10^(-3))+(ref/2)+(j-1)*ref; r(j,4)=ref; r(j,5)=(3*pi)/2;
end
%Nd= da1+da2+da3+da4+da5+dd1+dd2+dd3+dd4;
%dd4
for j=1+Ns+da1+da2+da3+da4+da5+dd1+dd2+dd3:dd4+Ns+da1+da2+da3+da4+da5+dd1+dd2+dd3
   r(j,1)=j; r(j,2)=13*(10^(-3))+(ref/2)+(j-1)*ref; r(j,3)=0.1*(10^(-3)); r(j,4)=ref; r(j,5)=pi;
end
toc
...
for j=1:cd1
    %temp(j,1)=0;
    Q(1,1)= temp(j,1);
    Q(1,1)= temp(j,1) + (cdensity(j,1));
    Density_q(1,1)=(Q(1,1))/cd1;
end
%    cd2
for j=(cd1+1):(cd1+cd2)
    %temp(j,1)=0;
    Q(2,1)= temp(j,1);
    Q(2,1)= temp(j,1) + (cdensity(j,1));
    Density_q(2,1)=(Q(2,1))/cd2;
end
%    cd3
for j=(cd1+cd2+1):(cd1+cd2+cd3)
    %temp(j,1)=0;
    Q(3,1)= temp(j,1);
    Q(3,1)= temp(j,1) + (cdensity(j,1));
    Density_q(3,1)=(Q(3,1))/cd3;
end
%    cd4
for j=(cd1+cd2+cd3+1):(cd1+cd2+cd3+cd4)
    %temp(j,1)=0;
    Q(4,1)= temp(j,1);
    Q(4,1)= temp(j,1) + (cdensity(j,1));
    Density_q(4,1)=(Q(4,1))/cd4;
end
%    cd5
for j=(cd1+cd2+cd3+cd4+1):(cd1+cd2+cd3+cd4+cd5)
    %temp(j,1)=0;
    Q(5,1)= temp(j,1);
    Q(5,1)= temp(j,1) + (cdensity(j,1));
    Density_q(5,1)=(Q(5,1))/cd5;
end
%    ca1
for j=(cd1+cd2+cd3+cd4+ca1+1):(cd1+cd2+cd3+cd4+cd5+ca1)
    %temp(j,1)=0;
    Q(6,1)= temp(j,1);
    Q(6,1)= temp(j,1) + (cdensity(j,1));
    Density_q(6,1)=(Q(6,1))/ca1;
end
%    ca2
for j=(cd1+cd2+cd3+cd4+ca1+ca2+1):Ns
    %temp(j,1)=0;
    Q(7,1)= temp(j,1);
    Q(7,1)= temp(j,1) + (cdensity(j,1));
    Density_q(7,1)=(Q(7,1))/ca2;
end
%da1
for j=(Ns+1):Ns+da1
    %temp(j,1)=0;
    Q(8,1)= temp(j,1);
    Q(8,1)= temp(j,1) + (cdensity(j,1));
    Density_q(8,1)=(Q(8,1))/da1;
end
%da2
for j=(Ns+1)+da1:Ns+da1+da2
    %temp(j,1)=0;
    Q(9,1)= temp(j,1);
    Q(9,1)= temp(j,1) + (cdensity(j,1));
    Density_q(9,1)=(Q(9,1))/da2;
end
%da3
for j=(Ns+1)+da1+da2:Ns+da1+da2+da3
    %temp(j,1)=0;
    Q(10,1)= temp(j,1);
    Q(10,1)= temp(j,1) + (cdensity(j,1));
    Density_q(10,1)=(Q(10,1))/da3;
end
%da4
for j=(Ns+1)+da1+da2+da3:Ns+da1+da2+da3+da4
    %temp(j,1)=0;
    Q(11,1)= temp(j,1);
    Q(11,1)= temp(j,1) + (cdensity(j,1));
    Density_q(11,1)=(Q(11,1))/da4;
end
%da5
for j=(Ns+1)+da1++da2+da3+da4:Ns+da1+da2+da3+da4+da5
    %temp(j,1)=0;
    Q(12,1)= temp(j,1);
    Q(12,1)= temp(j,1) + (cdensity(j,1));
    Density_q(12,1)=(Q(12,1))/da5;
end
%dd1
for j=(Ns+1)+da1+da2+da3+da4+da5:Ns+da1+da2+da3+da4+da5+dd1
    %temp(j,1)=0;
    Q(13,1)= temp(j,1);
    Q(13,1)= temp(j,1) + (cdensity(j,1));
    Density_q(13,1)=(Q(13,1))/dd1;
end
%dd2
for j=(Ns+1)+da1+da2+da3+da4+da5+dd1:Ns+da1+da2+da3+da4+da5+dd1+dd2
    %temp(j,1)=0;
    Q(14,1)= temp(j,1);
    Q(14,1)= temp(j,1) + (cdensity(j,1));
    Density_q(14,1)=(Q(14,1))/dd2;
end
%dd3
for j=(Ns+1)+da1+da2+da3+da4+da5+dd1+dd2:Ns+da1+da2+da3+da4+da5+dd1+dd2+dd3
    %temp(j,1)=0;
    Q(15,1)= temp(j,1);
    Q(15,1)= temp(j,1) + (cdensity(j,1));
    Density_q(15,1)=(Q(15,1))/dd3;
end
%dd4
for j=(Ns+1)+da1+da2+da3+da4+da5+dd1+dd2+dd3:N
    %temp(j,1)=0;
    Q(16,1)= temp(j,1);
    Q(16,1)= temp(j,1) + (cdensity(j,1));
    Density_q(16,1)=(Q(16,1))/dd4;
end
